...
public class DLMyList <E> {
	...
	private void add(E data, DLListElement<E> current) {
		...
		DLListElement<E> newElement = 
				new DLListElement<E>(data,current.getPrev(),current);
		//TEilschritt 2:
	...
	public String toString() {
		...
		for(DLListElement<E> currentElement = entry.getNext();
				currentElement != entry;
				currentElement = currentElement.getNext()) {
			erg += currentElement.getData() == this ? "Liste selbst" :
				currentElement.getData().toString();
