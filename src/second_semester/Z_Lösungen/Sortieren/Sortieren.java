...
public class Sortieren
{
    ...
    public static void bubbleSortMitAusgaben(int[] zahlen)
    {
        ...
        System.out.println(anzahl + " Vertauschungen durchgef�hrt");
    }
     ...
     */
     public static void main(String[] args)
     {
        ...
        System.out.println("Zeitvergleich bei " + anzahlGross 
                + " Array-Elementen und " + anzahlWiederholungen + " Testl�ufen:");
        a0 = worstArray(anzahlGross);
        

        // Zeitmessungen

        // Zeitbedarf f�r das Array-Klonen bestimmen
        ...
        System.out.println("Zeit f�r bubbleSort: " + (t2 - t1 - tconst)/anzahlWiederholungen);
        ...
        t2 = System.currentTimeMillis();
        System.out.println("Zeit f�r bubbleSortMitAbbruch: " + (t2 - t1 - tconst)/anzahlWiederholungen);
        ...
        t2 = System.currentTimeMillis();
        System.out.println("Zeit f�r selectionSort: " + (t2 - t1 - tconst)/anzahlWiederholungen);
        ...
        t2 = System.currentTimeMillis();
        System.out.println("Zeit f�r insertionSort: " + (t2 - t1 - tconst)/anzahlWiederholungen);
