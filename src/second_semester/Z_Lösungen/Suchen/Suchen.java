...
public class Suchen {
	...
	/**
	 * 
	 * Aufrufprozedur fuer die rekursive binaere Suche f�r ein geordnetes int-Array
	 * 
	 * @param zahlen  zu durchsuchendes Array
	 * @param gesucht Zahl die gesucht wird
	 * @return Index der Zahl oder falls gesuchte Zahl nicht enthalten: -1
	...
	/**
	 * 
	 * rekursives binaeres Suchverfahren f�r ein geordnetes int-Array
	 * 
	 * @param zahlen  zu durchsuchendes Array
	 * @param gesucht Zahl die gesucht wird
	...
	/**
	 * 
	 * iteratives binaeres Suchverfahren f�r ein geordnetes int-Array
	 * 
	 * @param zahlen  zu durchsuchendes Array
	 * @param gesucht Zahl die gesucht wird
	 * @return Index der Zahl oder falls gesuchte Zahl nicht enthalten: -1
	...
	public static void main(String[] args) {
		...
		System.out.println("sequentielle Suche - Grundalgorithmus, Exceptions m�glich");
		...
		// zahlen = randIntegerArray(anzahl);//ggf. mit neuen Array durchfuehren
		System.out.println("sequentielle Suche mit Pr�fung der Array-Grenze");
		time = System.currentTimeMillis();
		for (i = 0; i < testanzahl; i++) {
		...
		System.out.println("rekursive bin�re Suche");
		time = System.currentTimeMillis();
		for (i = 0; i < testanzahl; i++) {
		...
		System.out.println("iterative bin�re Suche");
		time = System.currentTimeMillis();
		for (i = 0; i < testanzahl; i++) {
